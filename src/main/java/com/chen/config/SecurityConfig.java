        ...
        http.authorizeRequests()
                ...
                .successHandler(new AuthenticationSuccessHandler() {
                    ...
                    public void onAuthenticationSuccess(HttpServletRequest req, HttpServletResponse resp, Authentication authentication) throws IOException, ServletException {
                        RestResponse ok = RestResponse.ok(authentication.getPrincipal()+"--"+authentication.getAuthorities()+"--"+authentication.getCredentials()+"--"+authentication.getDetails());
                ...
                .failureHandler(new AuthenticationFailureHandler() {
                    ...
                    public void onAuthenticationFailure(HttpServletRequest req, HttpServletResponse resp, AuthenticationException e) throws IOException, ServletException {
                        RestResponse error = RestResponse.fail("登录失败");
                        resp.setContentType("application/json;charset=utf-8");
                        PrintWriter out = resp.getWriter();
                ...
                .logoutSuccessHandler(new LogoutSuccessHandler() {
                    ...
                    public void onLogoutSuccess(HttpServletRequest req, HttpServletResponse resp, Authentication authentication) throws IOException, ServletException {
                        RestResponse ok = RestResponse.ok("注销成功！");
                        resp.setContentType("application/json;charset=utf-8");
                        PrintWriter out = resp.getWriter();
                        out.write(new ObjectMapper().writeValueAsString(ok));
                        out.flush();
                ...
                .accessDeniedHandler(new AccessDeniedHandler() {
                    ...
                    public void handle(HttpServletRequest req, HttpServletResponse resp, AccessDeniedException e) throws IOException, ServletException {
                        RestResponse error = RestResponse.fail("权限不足，访问失败");
                        resp.setStatus(403);
                        resp.setContentType("application/json;charset=utf-8");
                        PrintWriter out = resp.getWriter();
                        out.write(new ObjectMapper().writeValueAsString(error));
